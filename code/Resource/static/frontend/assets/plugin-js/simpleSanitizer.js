...
angular.module("htmlSanitize",[])
.directive("idyaHtmlSanitize",function(){
  ...
  return{
    ...
    replace: true,
    template: '<div>[[htmlSanitized]]</div>',
    link: function (scope, element, attrs) {
      function runSanitizer() {
        var parser = new HtmlWhitelistedSanitizer(true);
        var sanitizedHtml = parser.sanitizeString(attrs.html);
        scope.htmlSanitized = sanitizedHtml;
      }
      runSanitizer();
  }
  }
